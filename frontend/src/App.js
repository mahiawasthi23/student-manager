...
function App() {
  ...
  const fetchStudents = async () => {
    ...
    const res = await fetch("https://student-manager-app-nine.vercel.app/students")
  ...
  const addStudent = async () => {
    ...
    // await fetch("http://127.0.0.1:5000/students", {
      await fetch("https://student-manager-app-nine.vercel.app/students",{
      method: "POST",
  ...
  const deleteStudent = async (id) => {
    ...
    await fetch(`https://student-manager-app-nine.vercel.app/students/${id}`, {
      method: "DELETE",
    });
    fetchStudents();
  };
  ...
  const updateStudent = async () => {
    ...
    await fetch(`https://student-manager-app-nine.vercel.app/students/${editId}`, {
      method: "PUT",
      headers: { "Content-Type": "application/json" },
      body: JSON.stringify({ name, age, course }),
    });
